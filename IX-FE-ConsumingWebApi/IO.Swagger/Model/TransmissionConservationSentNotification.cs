...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransmissionConservationSentNotification :  IEquatable<TransmissionConservationSentNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransmissionConservationSentNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransmissionConservationSentNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransmissionConservationSentNotification" /> class.
        /// </summary>
        ...
        public TransmissionConservationSentNotification(string identificativoVersamento = default(string), string identificativoDocumento = default(string))
        {
            // to ensure "identificativoVersamento" is required (not null)
            if (identificativoVersamento == null)
            {
                throw new InvalidDataException("identificativoVersamento is a required property for TransmissionConservationSentNotification and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identificativoDocumento is a required property for TransmissionConservationSentNotification and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransmissionConservationSentNotification {\n");
        ...
        {
            return this.Equals(input as TransmissionConservationSentNotification);
        }

        /// <summary>
        /// Returns true if TransmissionConservationSentNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of TransmissionConservationSentNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransmissionConservationSentNotification input)
        {
            if (input == null)
                return false;
