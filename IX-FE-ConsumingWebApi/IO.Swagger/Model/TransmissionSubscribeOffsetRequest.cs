...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransmissionSubscribeOffsetRequest :  IEquatable<TransmissionSubscribeOffsetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransmissionSubscribeOffsetRequest" /> class.
        /// </summary>
        ...
        /// <param name="invoiceNotificationUtcDateOffset">Change the subscription offset pointing to the first invoice notification filtered by date in utc.  Notifications are available since 90 days.  If specified, the field InvoiceNotificationUIDOffset must be null..</param>
        public TransmissionSubscribeOffsetRequest(string invoiceNotificationUIDOffset = default(string), DateTime? invoiceNotificationUtcDateOffset = default(DateTime?))
        {
        ...
        /// <summary>
        /// Change the subscription offset pointing to the first invoice notification filtered by date in utc.  Notifications are available since 90 days.  If specified, the field InvoiceNotificationUIDOffset must be null.
        /// </summary>
        /// <value>Change the subscription offset pointing to the first invoice notification filtered by date in utc.  Notifications are available since 90 days.  If specified, the field InvoiceNotificationUIDOffset must be null.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransmissionSubscribeOffsetRequest {\n");
        ...
        {
            return this.Equals(input as TransmissionSubscribeOffsetRequest);
        }

        /// <summary>
        /// Returns true if TransmissionSubscribeOffsetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransmissionSubscribeOffsetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransmissionSubscribeOffsetRequest input)
        {
            if (input == null)
                return false;
